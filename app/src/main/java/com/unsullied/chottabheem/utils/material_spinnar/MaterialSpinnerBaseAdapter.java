...
package com.unsullied.chottabheem.utils.material_spinnar;
...
public abstract class MaterialSpinnerBaseAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            textView = (CustomTextView) convertView.findViewById(R.id.tv_tinted_spinner);
            ...
            textView = (CustomTextView) ((ViewHolder) convertView.getTag()).textView;
        }
