...
public class RoamingFragment extends Fragment implements PlansMVP.PlansView,PaymentGatewayMVP.View{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView=inflater.inflate(R.layout.fragment_roaming, container, false);
      ...
      //  mProgressDialog.show();
        ...
        includeLayout = rootView.findViewById(R.id.roamingPlansLayout);
        ...
        String url = AppConstants.RECHARGE_LIVE_URL + AppConstants.RECHARGE_PLAN_API + AppConstants.FORMAT_KEY + AppConstants.FORMAT_JSON_VALUE +
                AppConstants.TOKEN_KEY + AppConstants.TOKEN_VALUE + AppConstants.TYPE_KEY + AppConstants.RMG_VALUE +
