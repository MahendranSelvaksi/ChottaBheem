...
public class DataPlansFragment extends Fragment implements PlansMVP.PlansView, PaymentGatewayMVP.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_data_plans, container, false);
        ...
        includeLayout = rootView.findViewById(R.id.dataPlansLayout);
        ...
        String url = AppConstants.RECHARGE_LIVE_URL + AppConstants.RECHARGE_PLAN_API + AppConstants.FORMAT_KEY + AppConstants.FORMAT_JSON_VALUE +
                AppConstants.TOKEN_KEY + AppConstants.TOKEN_VALUE + AppConstants.TYPE_KEY + AppConstants.DATA_VALUE +
    ...
    public void errorShow(String errorMsg) {
        myUtility.printLogcat("Comes errorShow:::::" + errorMsg);
        mProgressDialog.dismiss();
        mPlansAdapter.notifyDataSetChanged();
